...
seccion = st.sidebar.radio("Selecciona sección", ["EDA", "Predicción"])  # EDA primero al abrir
...
if seccion == "EDA":
    ...
    # 1. El Problema de Negocio y el Contexto
    st.header("El Problema de Negocio y el Contexto")
    st.markdown("""
    ...
    """)
    st.image("/workspaces/equipoEnergias_XGB_con_Streamlit/data/Images/01.png", use_column_width=True)

    # 2. La Estrategia de Datos
    st.header("La Estrategia de Datos")
    st.markdown("""
    ...
    """)
    st.image("/workspaces/equipoEnergias_XGB_con_Streamlit/data/Images/02.png", use_column_width=True)

    # 3. La verdadera clave fue entender la inercia temporal
    st.header("La verdadera clave fue entender la inercia temporal")
    st.markdown("""
    ...
    """)
    st.image("/workspaces/equipoEnergias_XGB_con_Streamlit/data/Images/03.png", use_column_width=True)

    # 4. La Batalla de Modelos: XGBoost vs N-BEATS
    st.header("La Batalla de Modelos: XGBoost vs N-BEATS")
    st.markdown("""
    ...
    contra una arquitectura de Deep Learning moderna (N-BEATS).
    ...
    """)
    st.image("/workspaces/equipoEnergias_XGB_con_Streamlit/data/Images/04.png", use_column_width=True)

    # 5. Validación y Resultados
    st.header("Validación y Resultados")
    st.markdown("""
    ...
    """)
    st.image("/workspaces/equipoEnergias_XGB_con_Streamlit/data/Images/05.png", use_column_width=True)

    # 6. Limitaciones y Observaciones
    st.header("Limitaciones y Observaciones")
    st.markdown("""
...
if seccion == "Predicción":
    ...
    # -----------------------------
    # Crear bloque principal con sliders
    # -----------------------------
    st.markdown(
        """
        <div style="
    ...
    es_finde_texto = "Sí" if es_finde_num else "No"
